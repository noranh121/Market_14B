...
import main.Web.Requests.*;
import main.web.Requests.cartOp;
...
public class UserController {
    ...
    @PostMapping("/enter-as-guest")
    public Response<String> enterAsGuest(){
        String res = service.EnterAsGuest();
    ...
    public Response<String> Register(@RequestBody ReqUser user){
         return service.Register(user.getUsername(), user.getPass());
    }
    ...
    public Response<String> EditPermissions(@RequestBody PermissionReq per){
    ...
    public Response<String> AssignStoreManager(@RequestBody PermissionReq per){
        return service.AssignStoreManager(pet.getStoreID(), per.getOwnerUserName(), per.getUsername(), per.getPType());
    }

    @PostMapping("/assign-store-owner")
    public Response<String> AssignStoreOnwer(@RequestBody PermissionReq per){
    ...
    public Response<String> unassignUser(@RequestBody PermissionReq per){
